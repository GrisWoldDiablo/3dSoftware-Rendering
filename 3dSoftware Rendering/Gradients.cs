...
namespace _3dSoftware_Rendering
{
    class Gradients
    {
        ...
        public Gradients(Vertex minYVert, Vertex midYVert, Vertex maxYVert)
        {
            ...
            m_oneOverZ[0] = 1.0f / minYVert.GetPosition()[3];
            m_oneOverZ[1] = 1.0f / midYVert.GetPosition()[3];
            m_oneOverZ[2] = 1.0f / maxYVert.GetPosition()[3];

            m_texCoordX[0] = minYVert.GetTexCoords()[0] * m_oneOverZ[0];
            m_texCoordX[1] = midYVert.GetTexCoords()[0] * m_oneOverZ[1];
            m_texCoordX[2] = maxYVert.GetTexCoords()[0] * m_oneOverZ[2];

            m_texCoordY[0] = minYVert.GetTexCoords()[1] * m_oneOverZ[0];
            m_texCoordY[1] = midYVert.GetTexCoords()[1] * m_oneOverZ[1];
            m_texCoordY[2] = maxYVert.GetTexCoords()[1] * m_oneOverZ[2];
